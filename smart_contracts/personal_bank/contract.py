...
class PersonalBank(ARC4Contract):
    ...
    def __init__(self) -> None:
        ...
        self.github = BoxMap(Account, String, key_prefix="github_")

    @abimethod()
    def deposit(
        self, pay_txn: gtxn.PaymentTransaction, github_handle: String
    ) -> UInt64:
        ...
        Args:
            ...
            github_handle: The GitHub handle associated with the deposit
